...
forEach([1, 2, 3], (v) => console.log(v + 20));

console.log("\nCHALLENGE 5");
function mapWith(array, callback) {
  const outputArray = [];
  forEach(array, (v) => outputArray.push(callback(v)));
  return outputArray;
}

console.log(mapWith([1, 2, 3], (v) => v / 2));

console.log("\nCHALLENGE 6");
function reduce(array, callback, initialValue) {
  forEach(
    array,
    (arrayItem) => (initialValue = callback(initialValue, arrayItem))
  );
  return initialValue;
}
